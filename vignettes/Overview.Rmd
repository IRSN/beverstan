...
output:
    rmarkdown::html_vignette:
        toc: true
vignette: >
    %\VignetteIndexEntry{Overview of hte beverstan package}
...
```{r message=FALSE, warning=FALSE, fig.width=7, fig.height=3, fig.align="center", out.width="60%"}
...
```{r message=FALSE, warning=FALSE, fig.width=8, fig.height=4, fig.align="center", out.width="60%"}
myRL <- RL(fit)
...
```{r message=FALSE, warning=FALSE, fig.width=8, fig.height=4, out.width="60%", fig.align="center"}
...
```{r message=FALSE, warning=FALSE, fig.width=6, fig.height=3, fig.align="center", out.width="60%"}
...
```{r message=FALSE, results="hide", warning=FALSE, fig.width=10, fig.height=4}
